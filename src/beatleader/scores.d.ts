...
interface ContextExtension2 {
    ...
    player: Player;
    leaderboardId: string;
    leaderboard: CapturedLeaderboard;
    weight: number;
    rank: number;
    baseScore: number;
    modifiedScore: number;
...
export interface BLScoresCompact {
    metadata: Metadata;
    data: Datum2[];
}

export interface BLScoresOptions {
    sortBy?: string,
    order?: 0 | 1,
    page?: number,
    count?: number,
    ...
    diff?: string,
    mode?: string,
    requirements?: 0 | 2 | 4 | 8 | 16 | 32 | 64 | -1,
    scoreStatus?: 0 | 1,
...
export interface BLHistogramOptions extends BLScoresOptions {
    batch?: number,
}

export interface BLAccGraph {
    leaderboardId: string;
    diff: string;
    mode: string;
    modifiers: string;
...
export interface BLScoresHistory {
    id: number;
    context: number;
    timestamp: number;
    playerId: string;
